  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        <section className="container px-4 py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="flex flex-col items-center text-center p-6 rounded-lg border border-gray-200/50 dark:border-gray-800/50 bg-card hover:shadow-lg transition-all duration-300">
        ...
        {/* Call to Action */}
        <section className="container px-4 py-16 md:py-24">
          <div className="max-w-4xl mx-auto bg-card rounded-xl border border-border p-8 md:p-12 shadow-lg text-center">
